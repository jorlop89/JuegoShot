...
public class ConfiguracionesNormal {
	...
	//public static Integer[] highscores = new Integer[] {160,140,130,110,90};
	//public static String [] nicksscores= new String[] {"Alvaro","Jose","Maria","Fran","Celia"};
	public static String [] nicksscores= new String[] {"","","","",""};
	
	public final static String fileNormal = ".shotnormal";

	public static void load(FileIO files){
		BufferedReader in = null;
		try {
			in= new BufferedReader(new InputStreamReader(files.leerArchivo(fileNormal)));
	...
	public static void save(FileIO files){
		...
		try{
			out= new BufferedWriter(new OutputStreamWriter(files.escribirArchivo(fileNormal)));
