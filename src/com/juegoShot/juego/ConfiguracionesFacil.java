...
public class ConfiguracionesFacil {
	...
	//public static Integer[] highscores = new Integer[] {130,110,90,70,60};
	public static Integer[] highscores = new Integer[] {0,0,0,0,0};
	//public static String [] nicksscores= new String[] {"Cristina","Alex","Javier","Marta","Veronica"};
	public static String [] nicksscores= new String[] {"","","","",""};
	
	public final static String fileFacil = ".shotfacil";
	

	public static void load(FileIO files){
		BufferedReader in = null;
		try {
			in= new BufferedReader(new InputStreamReader(files.leerArchivo(fileFacil)));
	...
	public static void save(FileIO files){
		...
		try{
			out= new BufferedWriter(new OutputStreamWriter(files.escribirArchivo(fileFacil)));
